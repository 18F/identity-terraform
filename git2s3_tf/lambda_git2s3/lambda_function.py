...
# distutils.util is not supported in Python 3.12; use explicitly-defined function instead
def strtobool (val):
    val = val.lower()
...
exclude_git = bool(strtobool(os.environ['ExcludeGit']))
