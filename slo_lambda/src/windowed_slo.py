...
class SLIBase:
    ...
    def get_ratio(self) -> float:
        """
        get_ratio must be implemented in the child classes.
        We define it here to keep the type checker happy.
        """
...
class AvailabilitySLI(SLIBase):
    """
    AvailabilitySLI calculates an SLI definition as a ratio of good requests to
    valid requests.
...
def create_slis(slis: Dict[str, SLIBase]):
    """
